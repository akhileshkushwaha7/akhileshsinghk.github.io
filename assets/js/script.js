...
const SKILLS = [
  ...
  { title: "Healthcare & Compliance", tags: ["HIPAA", "PHI De-identification", "RBAC", "HL7 / FHIR", "ICD-10"] },
];
...
const EXPERIENCE = [
  {
    ...
    current: true,
    bullets: [
      "Architected a production-grade Agentic RAG platform (Python 3.12 / FastAPI) powering a multi-hospital clinical-documentation assistant across Nashville, TN and Boston, MA.",
      ...
      "Spearheaded distributed multi-agent orchestration on LangGraph + Claude 3.5 Sonnet — a 32-node state-graph orchestrator with Human-in-the-Loop pauses for clinician review.",
    ],
    extra: [
      "Implemented CCM-driven dual-path failover, saga-style compensating transactions, and circuit-breaker resilience across 6 distributed microservices (REST + gRPC).",
      ...
      "Owned ML evaluation & AI security pipelines: 3-stage eval (System/API + Champion/Challenger LLM judge + human clinical expert) with prompt-injection hardening and SHA-256 audit-run deduplication.",
      "Validated 71% weighted adherence on a production 16-step clinical-documentation SOP; led a 5-hour P1 incident response and authored the full post-mortem.",
      "Applied PHI de-identification (Safe Harbor) and BAA-aware vendor evaluation for HIPAA Privacy & Security Rule compliance across all third-party LLM integrations.",
      "Built Databricks-native agent tooling — PySpark/Spark SQL over Delta Lake in a Unity Catalog Lakehouse — mining conversation telemetry and Langfuse spans to surface SOP-adherence drift.",
    ],
